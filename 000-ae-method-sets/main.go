...
import (
	"fmt"
	"learn-go-v-three/000-ae-method-sets/interfaceimp"
	"learn-go-v-three/000-ae-method-sets/interfaceimplementation"
	"learn-go-v-three/000-ae-method-sets/thisallworks"
)
